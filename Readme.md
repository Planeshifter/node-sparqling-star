...
To give you an idea how the package, we are going through the steps of creating a call to [DBpedia][dbpedia] and printing the fetched results to the console. Our objective is to load all the names of the music albums from Eminem. After loading the package, we can construct a query object as follows:
